...
public class Assignment  {
  ...
  public void passValuestoFields() {
	  ...
	  Select month = new Select(driver.findElement(By.xpath("/html/body/div/form/div[8]/div[1]/select")));   		
	    month.selectByVisibleText("March");  
	    
	    Select day = new Select(driver.findElement(By.xpath("/html/body/div/form/div[8]/div[2]/select")));   		
	    day.selectByVisibleText("2"); 
	    
	    Select gender = new Select(driver.findElement(By.xpath("/html/body/div/form/div[7]/div/select")));   		
	    gender.selectByVisibleText("Female");
	    
	    Select year = new Select(driver.findElement(By.xpath("/html/body/div/form/div[8]/div[3]/select")));   		
...
@Test(priority=6)
  ...
  public void Question_01() throws InterruptedException {
